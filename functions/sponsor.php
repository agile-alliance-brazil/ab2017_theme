...
class sponsor_widget extends WP_Widget{
	...
	function __construct(){
		parent::__construct(
			...
			__('Agile Brazil 2017 - Sponsors', 'sponsor_widget_domain'),// Widget name will appear in UI
...
class cta_sponsor_widget extends WP_Widget{
	...
	function __construct(){
		parent::__construct(
			'wpb_widget',// Base ID of your widget
			__('Agile Brazil 2017- CTA Sponsor', 'cta_sponsor_widget_domain'),// Widget name will appear in UI
