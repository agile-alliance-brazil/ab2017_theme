...
class subscribe_widget extends WP_Widget{
	...
	function __construct(){
		parent::__construct(
			...
			__('Agile Brazil 2017 - Subscribe', 'subscribe_widget_domain'),// Widget name will appear in UI
...
function subscribe_function(){ ?>
	<section id="newsletter" class="section">
		<div class="container">
			<h1><?php _e("Signup for our newsletter", 'ab2017')?></h1>
			<div class="info">
				...
				<div class="text">
					<h4><?php _e("Don't miss out on anything that is happening in Agile Brazil. Sign up for our newsletter and receive all the information in your email!", 'ab2017')?></h4>
				</div>
			</div>
		</div>
	</section>
